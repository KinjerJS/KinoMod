...
public class GuiCrystaliser extends GuiPoweredBase
{
	public static final String TEX_PATH = "kinomod:textures/gui/container/crystaliser.png";
	private static final ResourceLocation TEXTURE = new ResourceLocation(TEX_PATH);
	private TileCrystaliser myTile;
	...
	public GuiCrystaliser(InventoryPlayer inventory, TileEntity tile) {

			super(new ContainerCrystaliser(inventory, tile), tile, inventory.player, TEXTURE);

			generateInfo("tab.kinomod.machine.crystaliser");

			myTile = (TileCrystaliser) tile;
		}
