...
public class EntityGhastBoss extends EntityFlying implements IMob
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(7, new EntityGhastBoss.AILookAround(this));
        this.tasks.addTask(7, new EntityGhastBoss.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase
        {
            private final EntityGhastBoss parentEntity;
            public int attackTimer;

            public AIFireballAttack(EntityGhastBoss entityGhastBoss)
            {
                this.parentEntity = entityGhastBoss;
            }
    ...
    static class AILookAround extends EntityAIBase
        {
            ...
            public AILookAround(EntityGhastBoss entityGhastBoss)
            {
                this.parentEntity = entityGhastBoss;
                this.setMutexBits(2);
            }
    ...
    static class AIRandomFly extends EntityAIBase
        {
            ...
            public AIRandomFly(EntityGhastBoss entityGhastBoss)
            {
                this.parentEntity = entityGhastBoss;
                this.setMutexBits(1);
            }
    ...
    static class GhastMoveHelper extends EntityMoveHelper
        {
            ...
            public GhastMoveHelper(EntityGhastBoss entityGhastBoss)
            {
                super(entityGhastBoss);
                this.parentEntity = entityGhastBoss;
            }
