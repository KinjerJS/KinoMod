...
public class EntityGhastBossKFireball extends EntityFireball
{
    public int explosionPower = 1;

	public EntityGhastBossKFireball(World worldIn)
    {
        super(worldIn);
    ...
    public EntityGhastBossKFireball(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn, x, y, z, accelX, accelY, accelZ);
        this.setSize(1.0F, 1.0F);
    }

    public EntityGhastBossKFireball(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
