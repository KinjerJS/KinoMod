...
public class EntityGhastBossSFireball extends EntityFireball
{
    public int explosionPower = 1;

	public EntityGhastBossSFireball(World worldIn)
    {
        super(worldIn);
    ...
    public EntityGhastBossSFireball(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn, x, y, z, accelX, accelY, accelZ);
        this.setSize(1.0F, 1.0F);
    }

    public EntityGhastBossSFireball(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
