...
public class EntityGhastBossK extends EntityFlying implements IMob {
	...
	public static int playerScoreK = 0;
	...
	private static final DataParameter<Boolean> ATTACKING = EntityDataManager.<Boolean>createKey(EntityGhastBossK.class,
			DataSerializers.BOOLEAN);
	private static final DataParameter<Integer> PHASE = EntityDataManager.<Integer>createKey(EntityGhastBossK.class,
			DataSerializers.VARINT);

	private int explosionStrength = 6;

	public EntityGhastBossK(World worldIn) {
		super(worldIn);
		this.setSize(10.0f, 10.0f);
		this.isImmuneToFire = true;
		this.experienceValue = (int) XP_VALUE;
		this.moveHelper = new EntityGhastBossK.GhastMoveHelper(this);
	}

	@Override
	protected void initEntityAI() {
		this.tasks.addTask(5, new EntityGhastBossK.AIRandomFly(this));
		this.tasks.addTask(7, new EntityGhastBossK.AILookAround(this));
		this.tasks.addTask(7, new EntityGhastBossK.AIFireballAttack(this));
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		...
		else if (source.getImmediateSource() instanceof EntityGhastBossKFireball
...
//	}
    ...
    {
        EntityItem entityitem = this.dropItem(InitItems.ghast_boss_tentacle_k, 1);
        ...
        EntityItem entityitem2 = this.dropItem(InitItems.kinium, 3);
	...
	public void removeTrackingPlayer(EntityPlayerMP player) {
		...
		this.playerScoreK -= this.playerScoreK;
		this.heal(750.0F);
	}
	...
	public void processGhastDeath(EntityGhastBossK ghastbossd) {
	...
	protected void onDeathUpdate() {
		...
		if (this.deathTicks == 20) {
			GuiPlayerScore.renderPlayerScoreK = true;
		}
		...
		if (this.deathTicks == 200 && !this.world.isRemote) {
			...
			GuiPlayerScore.renderPlayerScoreK = false;
			this.playerScoreK -= this.playerScoreK;
	...
	static class AIFireballAttack extends EntityAIBase {
		private final EntityGhastBossK parentEntity;
		public int attackTimer;
		public int shootTimer;

		public AIFireballAttack(EntityGhastBossK entityGhastBossK) {
			this.parentEntity = entityGhastBossK;
		}
		...
		public void updateTask() {
			...
			if (entitylivingbase.getDistanceSq(this.parentEntity) < 4096.0D) {
				...
				if (this.attackTimer == 10) {
					...
					EntityGhastBossKFireball entitylargefireball = new EntityGhastBossKFireball(world, this.parentEntity, d2, d3,
							d4);
					...
					EntityGhastBossK.playerScoreK += 1;
					this.attackTimer = -20;
				}
	...
	static class AILookAround extends EntityAIBase {
		...
		public AILookAround(EntityGhastBossK entityGhastBossK) {
			this.parentEntity = entityGhastBossK;
			this.setMutexBits(2);
		}
	...
	static class AIRandomFly extends EntityAIBase {
		...
		public AIRandomFly(EntityGhastBossK entityGhastBossK) {
			this.parentEntity = entityGhastBossK;
			this.setMutexBits(1);
		}
	...
	static class GhastMoveHelper extends EntityMoveHelper {
		...
		public GhastMoveHelper(EntityGhastBossK entityGhastBossK) {
			super(entityGhastBossK);
			this.parentEntity = entityGhastBossK;
		}
