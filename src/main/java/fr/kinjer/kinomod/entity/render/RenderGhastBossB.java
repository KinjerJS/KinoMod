...
public class RenderGhastBossB extends RenderLiving<EntityGhastBossB> {
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityGhastBossB entity) {
		if (entity.isPhase(1))
	 ...
	 * rendered.
	 */
	protected void preRenderCallback(EntityGhastBossB entitylivingbaseIn, float partialTickTime) {
		float f = 1.0F;
		float f1 = 4.5F;
		float f2 = 4.5F;
