...
public class ContainerCrystaliser extends ContainerTileAugmentable implements ISlotValidator {

	TileCrystaliser myTile;

	public ContainerCrystaliser(InventoryPlayer inventory, TileEntity tile) {
