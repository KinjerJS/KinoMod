...
public class Config {
	...
	public static int ENTITY_GHAST_BOSS_B = 123;
	public static int ENTITY_GHAST_BOSS_K = 124;
	...
	public static int ENTITY_GHAST_BOSS_FIREBALL_B = 128;
	public static int ENTITY_GHAST_BOSS_FIREBALL_K = 129;
	...
	public static void loadData() {
		...
		ENTITY_GHAST_BOSS_B = config.getInt("config.category.id.ghastbossb", "entity", 123, 120, 2147483000, "Change the ID of Balium Ghast.");
		ENTITY_GHAST_BOSS_K = config.getInt("config.category.id.ghastbossk", "entity", 124, 120, 2147483000, "Change the ID of Kinium Ghast.");
		...
		ENTITY_GHAST_BOSS_FIREBALL_B = config.getInt("config.category.id.ghastfireballb", "entity", 128, 120, 2147483000, "Change the ID of Balium Ghast Projectile.");
		ENTITY_GHAST_BOSS_FIREBALL_K = config.getInt("config.category.id.ghastfireballk", "entity", 129, 120, 2147483000, "Change the ID of Kinium Ghast Projectile.");
