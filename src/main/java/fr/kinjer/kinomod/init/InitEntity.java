...
public class InitEntity {
	...
	public static void registerEntities() {
		...
		registerEntity("ghast_boss_b", EntityGhastBossB.class, Config.ENTITY_GHAST_BOSS_B, 50, 0xFF865A, 0x9B4D00);
		registerEntity("ghast_boss_k", EntityGhastBossK.class, Config.ENTITY_GHAST_BOSS_K, 50, 0xFF865A, 0x9B4D00);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(KinoMod.MODID, "ghast_fireball_b"), EntityGhastBossBFireball.class, "ghast_balium_projectile", Config.ENTITY_GHAST_BOSS_FIREBALL_B, KinoMod.MODID, 64, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation(KinoMod.MODID, "ghast_fireball_k"), EntityGhastBossKFireball.class, "ghast_kinium_projectile", Config.ENTITY_GHAST_BOSS_FIREBALL_K, KinoMod.MODID, 64, 1, true);
	}
