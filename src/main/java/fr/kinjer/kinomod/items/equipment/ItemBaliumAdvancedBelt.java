...
import fr.kinjer.kinomod.items.base.ItemKinoBauble;
...
public class ItemBaliumAdvancedBelt extends ItemKinoBauble {
	...
	public ItemBaliumAdvancedBelt() {
		super("balium_belt_advanced");
	}
	...
	public static void onKeyDown(KeyInputEvent event) {
		...
		int slot = BaublesApi.isBaubleEquipped(mc.player, InitItems.balium_belt_advanced);
		if (slot < 0) {
			return;
		}
